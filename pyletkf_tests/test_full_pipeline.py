...
from pyletkf.full_pipeline import process_full_pipeline
from pyletkf.io import load_letkf_state
from pyletkf.params import MEMBERS


def ignore_test_full_pipeline_reproduces_fortran_analysis():
    ...
    truth = load_letkf_state(dump_dir, pe_tag, "anal").sel(ens=list(MEMBERS))["state"].to_dataarray()
